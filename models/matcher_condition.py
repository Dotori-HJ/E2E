...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        cost_seg = torch.cdist(segment_clr_to_t1t2(out_seg), segment_cw_to_t1t2(tgt_seg), p=1)

        # Compute the iou cost betwen segments
        cost_iou = -segment_iou(segment_clr_to_t1t2(out_seg), segment_cw_to_t1t2(tgt_seg))
