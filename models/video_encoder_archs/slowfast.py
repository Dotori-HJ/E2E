...
class ResNet3dSlowFast(nn.Module):
    ...
    def __init__(self,
        ...
        self.out_indices = (3, )
        self.slow_poolers = nn.ModuleList([SpatialPooler('twpool', input_dim=2048, base_dim=2048, num_layers=1)])
        self.fast_poolers = nn.ModuleList([SpatialPooler('twpool', input_dim=256, base_dim=256, num_layers=1)])
