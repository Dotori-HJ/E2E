...
class ResNet3dSlowFast(nn.Module):
    ...
    def __init__(self,
        ...
        if pooler == 'avg':
            ...
            self.slow_poolers = nn.ModuleList([SpatialPooler('twpool', input_dim=2048, base_dim=256, num_layers=2)])
            self.fast_poolers = nn.ModuleList([SpatialPooler('twpool', input_dim=256, base_dim=32, num_layers=2)])
            # self.num_channels = 2304
