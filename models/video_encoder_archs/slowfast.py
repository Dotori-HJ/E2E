...
class ResNet3dSlowFast(nn.Module):
    ...
    def __init__(self,
        ...
        if pooler == 'avg':
            ...
            self.slow_poolers = nn.ModuleList([SpatialPooler('twpool', input_dim=2048, base_dim=1024, num_layers=4, skip='avg')])
            self.fast_poolers = nn.ModuleList([SpatialPooler('twpool', input_dim=256, base_dim=128, num_layers=4, skip='avg')])
