# Modified from torchvision.datasets.video_utils
...
class VideoClips:
    ...
    def get_clip(self, idx: int) -> Tuple[torch.Tensor, torch.Tensor, Dict[str, Any], int]:
        ...
        info["src_vid_name"] = video_name
        start = (clip_idx * self.frames_between_clips) / self.frame_rate
        end = (clip_idx * self.frames_between_clips + self.clip_length_in_frames) / self.frame_rate
        info["video_name"] = video_name + f"_window_{start}_{end}"
